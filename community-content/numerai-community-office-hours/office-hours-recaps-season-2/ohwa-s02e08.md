...
**Why such a big difference in rank between** [**Integration Test**](http://numer.ai/integration_test) **and** [**Integration Test 7**](https://numer.ai/integration_test\_7)**?**
...
Thank you to_ \[\_Slyfox_]\([https://twitter.com/ansonschu)\_,\_](https://twitter.com/ansonschu\)\_,\_) [_Keno_](https://numer.ai/wander)_, and_ [_Wigglemuse_](https://numer.ai/wigglemuse) _for contributing to answers during this Office Hours, to_ [_Bouwe Ceunen_](https://twitter.com/BouweCeunen) _for being interviewed and his work on the Numerai payouts app,_ _and to_ [_Arbitrage_](https://numer.ai/arbitrage) _for hosting._
