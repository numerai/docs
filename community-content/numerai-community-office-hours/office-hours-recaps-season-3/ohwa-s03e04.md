...
Thank you to_ \[\_Michael Oliver_]\([https://numer.ai/mdo](https://numer.ai/mdo)) _for talking about Nomi (again again), to_ [_Wigglemuse_](https://numer.ai/wigglemuse) _and_ [_JRB_ ](https://numer.ai/jrb)_for contributing to this week's discussion,_ _and to_ [_Arbitrage_](https://numer.ai/arbitrage) _for hosting._
